...
param endpoint string = 'https://foundryiqv2ppwne.services.ai.azure.com/api/projects/iqv2project/agents/orchestrator-agent/endpoint/protocols/activityProtocol?api-version=2025-05-15-preview'
